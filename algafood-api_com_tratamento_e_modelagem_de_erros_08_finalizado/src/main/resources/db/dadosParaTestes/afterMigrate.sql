...
SELECT setval('"zzz_cozinha_id_seq"', (SELECT max(id) FROM zzz_cozinha)); 
...
SELECT setval('"zzz_estado_id_seq"', (SELECT max(id) FROM zzz_estado)); 
...
SELECT setval('"zzz_cidade_id_seq"', (SELECT max(id) FROM zzz_cidade)); 
...
SELECT setval('"zzz_restaurante_id_seq"', (SELECT max(id) FROM zzz_restaurante)); 
...
SELECT setval('"zzz_forma_pagamento_id_seq"', (SELECT max(id) FROM zzz_forma_pagamento)); 
...
SELECT setval('"zzz_permissao_id_seq"', (SELECT max(id) FROM zzz_permissao)); 
...
SELECT setval('"zzz_produto_id_seq"', (SELECT max(id) FROM zzz_produto)); 
